    ...
    <div class="screen-login">
      <div class="card login-card">
        <div class="login-header">
          ...
          <h1>Cuarto Quiz</h1>
          <p class="subtitle">Pandas: DataFrame · Índice · Operaciones · Gráficos</p>
          <p class="subtitle">35 Preguntas — 50 Puntos</p>
        </div>
    ...
    <div class="screen-quiz">
      ...
      <header class="quiz-header">
        <div class="header-left">
          <span class="header-title">Cuarto Quiz</span>
